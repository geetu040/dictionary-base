...
export const Navbar = ({props}) => {
	...
	return (<>
		...
		<div className='fixed w-[100vw] px-9 py-2 flex items-center justify-between bg-dark-trans'>
			<div className='border border-dark dark:border-info bg-light text-dark dark:bg-dark dark:text-info px-3 py-1 cursor-pointer font-semibold rounded-lg font-mono'>
				Home
			</div>
